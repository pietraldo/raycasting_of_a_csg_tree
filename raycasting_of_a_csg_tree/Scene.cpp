...
void Scene::UpdateTextureGpu(unsigned char* dev_texture_data, float* dev_projection, float* dev_view, float* dev_camera_position, float* dev_light_position, int sphere_count,
	Node* dev_tree, float* dev_intersecion_points,float* dev_intersection_result, int* dev_parts, Sphere* dev_spheres, Cube* dev_cubes)
{
	...
	UpdateOnGPU(dev_texture_data, TEXTURE_WIDHT, TEXTURE_HEIGHT, sphere_count, dev_projection, dev_view, dev_camera_position, dev_light_position, dev_tree, 
