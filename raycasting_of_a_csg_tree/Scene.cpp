	...
	Node* dev_tree, float* dev_intersecion_points,float* dev_intersection_result)
{
	...
	UpdateOnGPU(dev_texture_data, TEXTURE_WIDHT, TEXTURE_HEIGHT, sphere_count, dev_projection, dev_view, dev_camera_position, dev_light_position, dev_tree, dev_intersecion_points, dev_intersection_result);
}
